OPCODES = {
    ...
    0x3e: ("RETURNDATACOPY", 3, 0, "Copy output data from the previous call to memory.", ("memOffset", "offset", "size")),
    ...
    0xa4: ("LOG4", 6, 0, "Append log record with four topics.", ("offset", "size", "topic1", "topic2", "topic3", "topic4")),
    0xf0: ("CREATE", 3, 1, "Create a new account with associated code.", ("value", "offset", "size")),
    0xf1: ("CALL", 7, 1, "Message-call into an account.", ("gas", "addr", "value", "argsOffset", "argsSize", "retOffset", "retSize")),
    0xf2: ("CALLCODE", 7, 1, "Message-call into this account with an alternative account's code.", ("gas", "addr", "value", "argsOffset", "argsSize", "retOffset", "retSize")),
    0xf3: ("RETURN", 2, 0, "Halt execution returning output data.", ("offset", "size")),
    0xf4: ("DELEGATECALL", 6, 1, "Message-call into this account with an alternative account's code, but persisting the current values for sender and value.", ("gas", "addr", "argsOffset", "argsSize", "retOffset", "retSize")),
    0xf5: ("CREATE2", 4, 1, "Create a new account with associated code at a predictable address", ("value", "offset", "size", "salt")),
    0xfa: ("STATICCALL", 6, 1, "Static message-call into an account.", ("gas", "addr", "argsOffset", "argsSize", "retOffset", "retSize")),
    0xfd: ("REVERT", 2, 0, "Halt execution reverting state changes but returning data and remaining gas.", ("offset", "size")),
