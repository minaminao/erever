OPCODES: dict[int, tuple[str, int, int, int, str, tuple[str, ...]]] = {
    ...
    0x05: ("SDIV", 2, 1, 5, "Signed integer division operation (truncated).", ("a", "b")),
    ...
    0x0B: ("SIGNEXTEND", 2, 1, 5, "Extend length of two's complement signed integer.", ("size", "x")),
    ...
    0x1D: ("SAR", 2, 1, 3, "Arithmetic (signed) right shift operation.", ("shift", "x")),
    ...
    0x35: ("CALLDATALOAD", 1, 1, 3, "Get input data of current environment.", ("offset",)),
    0x36: ("CALLDATASIZE", 0, 1, 2, "Get size of input data in current environment.", ()),
    0x37: (
        "CALLDATACOPY",
        3,
        0,
    ...
    0x39: ("CODECOPY", 3, 0, 3, "Copy code running in current environment to memory.", ("memOffset", "offset", "size")),
    0x3A: ("GASPRICE", 0, 1, 2, "Get price of gas in current environment.", ()),
    0x3B: ("EXTCODESIZE", 1, 1, 100, "Get size of an account's code.", ("addr",)),
    0x3C: ("EXTCODECOPY", 4, 0, 100, "Copy an account's code to memory.", ("addr", "memOffset", "offset", "size")),
    0x3D: (
        "RETURNDATASIZE",
        0,
        1,
    ...
    0x40: ("BLOCKHASH", 1, 1, 20, "Get the hash of one of the 256 most recent complete blocks.", ("number",)),
    ...
    0x57: ("JUMPI", 2, 0, 10, "Conditionally alter the program counter.", ("pc", "cond")),
    0x58: (
        "PC",
        0,
        1,
    ...
    0xA1: ("LOG1", 3, 0, 750, "Append log record with one topic.", ("offset", "size", "topic1")),
    0xA2: ("LOG2", 4, 0, 1125, "Append log record with two topics.", ("offset", "size", "topic1", "topic2")),
    0xA3: (
        "LOG3",
        5,
        0,
    ...
    0xF0: ("CREATE", 3, 1, 32000, "Create a new account with associated code.", ("value", "offset", "size")),
    0xF1: (
        "CALL",
        7,
        1,
    ...
    0xF3: ("RETURN", 2, 0, 0, "Halt execution returning output data.", ("offset", "size")),
    0xF4: (
        "DELEGATECALL",
        6,
        1,
    ...
    0xFF: ("SELFDESTRUCT", 1, 0, 5000, "Halt execution and register account for later deletion.", ("addr",)),
}
